...
export default function AnalysisResults({
  ...
  return (
    <div
      ref={resultsRef}
      className="flex-1 bg-white rounded-md p-8 shadow-sm min-h-[420px]"
    >
          ...
          analysis && (
            <div className="mt-8 p-6 bg-white rounded-md shadow-sm w-full">
              ...
              <div className="mt-8 flex flex-col md:flex-row justify-between gap-4">
                <button
                  className="bg-dviaprimary-40 hover:bg-dviaprimary-60 text-white font-medium py-2 px-4 rounded-md"
                  onClick={handleDownloadSectionAsPDF}
                >
                  Télécharger le rapport
                </button>
                <button
                  className="border border-dviaprimary-40 text-dviaprimary-40 hover:bg-dviaprimary-70 font-medium py-2 px-4 rounded-md"
